...
try { importScripts('/assets/js/a33-release.js?v=4.20.97&r=54'); } catch (_) {}
const VERSION = self.A33_RELEASE && self.A33_RELEASE.suiteVersion ? String(self.A33_RELEASE.suiteVersion) : '4.20.97';
...
const PRECACHE = [
  './',
  './index.html?v=4.20.97&r=4',
  './style.css?v=4.20.97&r=11',
  './script.js?v=4.20.97&r=16',
  './purchases.js?v=4.20.97&r=4',
  './manifest.webmanifest?v=4.20.97&r=1',
  './offline.html',
  '../icon-a33-192.png',
  '../icon-a33-512.png',
...
self.addEventListener('fetch', event => {
  ...
  if (event.request.mode === 'navigate') {
    ...
    }).catch(() => caches.match(event.request).then(hit => hit || caches.match('./index.html?v=4.20.97&r=4')).then(hit => hit || caches.match('./offline.html'))));
    return;
  }
