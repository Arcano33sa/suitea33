...
const PRECACHE = [
  './',
  './index.html?v=4.20.95&r=4',
  './style.css?v=4.20.95&r=11',
  './script.js?v=4.20.95&r=16',
  './purchases.js?v=4.20.95&r=4',
...
self.addEventListener('fetch', event => {
  ...
  if (event.request.mode === 'navigate') {
    ...
    }).catch(() => caches.match(event.request).then(hit => hit || caches.match('./index.html?v=4.20.95&r=4')).then(hit => hit || caches.match('./offline.html'))));
    return;
  }
