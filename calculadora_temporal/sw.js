  ...
  event.respondWith((async () => {
    ...
    try {
      ...
      return (await cache.match(event.request))
        || (isNavigation ? (await cache.match('./index.html?v=4.20.95&r=8')) || (await cache.match('./')) : null)
