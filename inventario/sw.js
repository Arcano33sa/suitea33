...
const PRECACHE_URLS = [
  ...
  './style.css?v=4.20.89&r=9',
  './script.js?v=4.20.89&r=14',
  './manifest.webmanifest?v=4.20.89&r=9',
  './offline.html',
  './images/logo.png',
  '/assets/js/a33-release.js?v=4.20.89&r=51',

  '/assets/js/a33-input-ux.js?v=4.20.89&r=8',
  ...
  '/assets/css/a33-header.css?v=4.20.89&r=8',
  '/assets/css/a33-theme.css?v=4.20.89&r=8',
  '/assets/js/a33-theme.js?v=4.20.89&r=8'
];
