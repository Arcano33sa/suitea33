...
const MODULE_CACHE_REV = '4';
const CACHE_NAME = `a33-v${SW_VERSION}-${MODULE}-r${SW_REV}-m${MODULE_CACHE_REV}`;

const PRECACHE_URLS = [
  './',
  './index.html?v=4.20.96&r=21',
  './style.css?v=4.20.96&r=17',
  './app.js?v=4.20.96&r=21',
  './manifest.webmanifest?v=4.20.96&r=4',
  './offline.html',
  '../icon-a33-192.png',
  '../icon-a33-512.png',
...
async function networkFirst(request){
  ...
  try{
    ...
    return (await cache.match(request)) ||
      (await cache.match('./index.html?v=4.20.96&r=21')) ||
