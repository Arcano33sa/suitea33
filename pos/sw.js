...
const PRECACHE_URLS = [
  './',
  './index.html?v=4.20.87&r=23',
  './styles.css?v=4.20.87&r=15',
  './app.js?v=4.20.87&r=29',
  './manifest.webmanifest?v=4.20.87&r=19',
  './offline.html',
  './logo.png',
  './vendor/xlsx.full.min.js?v=4.20.87&r=13',
  '/assets/js/a33-release.js?v=4.20.87&r=51',

  '/assets/js/a33-input-ux.js?v=4.20.87&r=13',
  ...
  '/assets/js/a33-sale-cost.js?v=4.20.87&r=2',
  '/assets/css/a33-header.css?v=4.20.87&r=13',
  '/assets/css/a33-theme.css?v=4.20.87&r=13',
  '/assets/js/a33-theme.js?v=4.20.87&r=13'
];
...
async function handleNavigate(request){
  try{
    ...
    return (
      ...
      (await cache.match('./index.html?v=4.20.87&r=23')) ||
