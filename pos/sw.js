...
try { importScripts('/assets/js/a33-release.js?v=4.20.84&r=48'); } catch (e) {}
...
async function handleNavigate(request){
  try{
    ...
    return (
      ...
      (await cache.match('./index.html?v=4.20.84&r=20')) ||
