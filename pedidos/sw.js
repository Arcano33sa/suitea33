...
const PRECACHE_URLS = [
  ...
  './style.css?v=4.20.80&r=7',
  './script.js?v=4.20.80&r=10',
  './vendor/xlsx.full.min.js?v=4.20.80&r=7',
  './manifest.webmanifest?v=4.20.80&r=7',
  './offline.html',
  './images/logo.png',
  '/assets/js/a33-release.js?v=4.20.80&r=44',

  '/assets/js/a33-input-ux.js?v=4.20.80&r=7',
  '/assets/js/a33-storage.js?v=4.20.80&r=7',
  '/assets/js/a33-currency.js?v=4.20.80&r=14',
  '/assets/css/a33-header.css?v=4.20.80&r=7',
  '/assets/js/a33-theme.js?v=4.20.80&r=7',
  '/assets/css/a33-theme.css?v=4.20.80&r=7'
];
