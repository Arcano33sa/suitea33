/* Suite A33 — Service Worker (Pedidos)
...
const PRECACHE_URLS = [
  './',
  './index.html?v=4.20.85&r=13',
  './style.css?v=4.20.85&r=8',
  './script.js?v=4.20.85&r=16',
  './vendor/xlsx.full.min.js?v=4.20.85&r=7',
  './manifest.webmanifest?v=4.20.85&r=8',
  './offline.html',
  './images/logo.png',
...
async function handleNavigate(request){
  try{
    ...
    return (
      ...
      (await cache.match('./index.html?v=4.20.85&r=13')) ||
