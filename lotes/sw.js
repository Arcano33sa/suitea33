...
const PRECACHE_URLS = [
  './',
  './index.html?v=4.20.94&r=16',
  './style.css?v=4.20.94&r=10',
  './script.js?v=4.20.94&r=16',
...
async function handleNavigate(request){
  try{
    ...
    return (
      ...
      (await cache.match('./index.html?v=4.20.94&r=16')) ||
