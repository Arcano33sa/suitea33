...
const PRECACHE_URLS = [
  './',
  './index.html?v=4.20.88&r=16',
  './style.css?v=4.20.88&r=10',
  './script.js?v=4.20.88&r=16',
  './manifest.webmanifest?v=4.20.88&r=11',
  './offline.html',
  './images/logo.png',
...
async function handleNavigate(request){
  try{
    ...
    return (
      ...
      (await cache.match('./index.html?v=4.20.88&r=16')) ||
