/* Suite A33 — Service Worker (Lotes)
...
const PRECACHE_URLS = [
  './',
  './index.html?v=4.20.96&r=19',
  './style.css?v=4.20.96&r=11',
  './script.js?v=4.20.96&r=21',
  ...
  './vendor/xlsx.full.min.js?v=4.20.96&r=7'
];
...
async function handleNavigate(request){
  try{
    ...
    return (
      ...
      (await cache.match('./index.html?v=4.20.96&r=19')) ||
