...
const PRECACHE_URLS = [
  './',
  './index.html?v=4.20.88&r=26',
  './style.css?v=4.20.88&r=19',
  './script.js?v=4.20.88&r=28',
  ...
  '/assets/js/a33-product-integrity.js?v=4.20.88&r=1',
  '/assets/js/a33-input-ux.js?v=4.20.88&r=11',
  '/assets/js/a33-theme.js?v=4.20.88&r=11',
  '/assets/css/a33-header.css?v=4.20.88&r=11',
  '/assets/css/a33-theme.css?v=4.20.88&r=11'
];
...
async function handleNavigate(request){
  try{
    ...
    return (
      ...
      (await cache.match('./index.html?v=4.20.88&r=26')) ||
