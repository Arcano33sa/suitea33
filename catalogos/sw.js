...
const PRECACHE_URLS = [
  './',
  './index.html?v=4.20.97&r=33',
  './style.css?v=4.20.97&r=24',
  './script.js?v=4.20.97&r=36',
  './manifest.webmanifest?v=4.20.97&r=13',
  './offline.html',
  '../icon-a33-192.png',
  '../icon-a33-512.png',
  ...
  '/assets/js/a33-input-ux.js?v=4.20.97&r=11',
  '/assets/js/a33-theme.js?v=4.20.97&r=11',
  '/assets/css/a33-header.css?v=4.20.97&r=11',
  '/assets/css/a33-theme.css?v=4.20.97&r=11'
];
...
async function handleNavigate(request){
  try{
    ...
    return (
      ...
      (await cache.match('./index.html?v=4.20.97&r=33')) ||
