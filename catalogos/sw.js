...
*/
try { importScripts('/assets/js/a33-release.js?v=4.20.85&r=49'); } catch (e) {}

const SW_VERSION = (self.A33_RELEASE && self.A33_RELEASE.suiteVersion) ? String(self.A33_RELEASE.suiteVersion) : '4.20.85';
...
const PRECACHE_URLS = [
  './',
  './index.html?v=4.20.85&r=26',
  './style.css?v=4.20.85&r=19',
  './script.js?v=4.20.85&r=28',
  './manifest.webmanifest?v=4.20.85&r=10',
  './offline.html',
  '../icon-a33-192.png',
  '../icon-a33-512.png',
  '/assets/js/a33-release.js?v=4.20.85&r=49',
  '/assets/js/a33-storage.js?v=4.20.85&r=19',
  '/assets/js/a33-product-integrity.js?v=4.20.85&r=1',
  '/assets/js/a33-input-ux.js?v=4.20.85&r=11',
  '/assets/js/a33-theme.js?v=4.20.85&r=11',
  '/assets/css/a33-header.css?v=4.20.85&r=11',
  '/assets/css/a33-theme.css?v=4.20.85&r=11'
];
...
async function handleNavigate(request){
  try{
    ...
    return (
      ...
      (await cache.match('./index.html?v=4.20.85&r=26')) ||
