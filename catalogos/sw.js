...
const SW_VERSION = (self.A33_RELEASE && self.A33_RELEASE.suiteVersion) ? String(self.A33_RELEASE.suiteVersion) : '4.20.80';
...
const PRECACHE_URLS = [
  './',
  './index.html?v=4.20.80&r=9',
  './style.css?v=4.20.80&r=8',
  './script.js?v=4.20.80&r=9',
  './manifest.webmanifest?v=4.20.80&r=7',
  './offline.html',
  '../icon-a33-192.png',
  '../icon-a33-512.png',
  '/assets/js/a33-release.js?v=4.20.80&r=44',
  '/assets/js/a33-storage.js?v=4.20.80&r=13',
  '/assets/js/a33-input-ux.js?v=4.20.80&r=11',
  '/assets/js/a33-theme.js?v=4.20.80&r=11',
  '/assets/css/a33-header.css?v=4.20.80&r=11',
  '/assets/css/a33-theme.css?v=4.20.80&r=11'
];
...
async function handleNavigate(request){
  try{
    ...
    return (
      ...
      (await cache.match('./index.html?v=4.20.80&r=9')) ||
