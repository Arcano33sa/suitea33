...
const PRECACHE_URLS = [
  './',
  './index.html?v=4.20.89&r=12',
  './manifest.webmanifest?v=4.20.89&r=10',
  './logo-icon-192.png',
  './logo-icon-512.png',
  '/assets/js/a33-release.js?v=4.20.89&r=51',
  '/assets/js/a33-storage.js?v=4.20.89&r=20',
  '/assets/js/a33-production.js?v=4.20.89&r=4',
  ...
  event.respondWith((async () => {
    ...
    try {
      ...
      return (await cache.match(event.request))
        || (isNavigation ? (await cache.match('./index.html?v=4.20.89&r=12')) || (await cache.match('./')) : null)
