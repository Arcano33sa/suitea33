...
const PRECACHE_URLS = [
  './',
  './index.html?v=4.20.96&r=16',
  './manifest.webmanifest?v=4.20.96&r=11',
  './logo-icon-192.png',
  './logo-icon-512.png',
  '/assets/js/a33-release.js?v=4.20.96&r=54',
  '/assets/js/a33-storage.js?v=4.20.96&r=20',
  '/assets/js/a33-production.js?v=4.20.96&r=5',
  ...
  event.respondWith((async () => {
    ...
    try {
      ...
      return (await cache.match(event.request))
        || (isNavigation ? (await cache.match('./index.html?v=4.20.96&r=16')) || (await cache.match('./')) : null)
