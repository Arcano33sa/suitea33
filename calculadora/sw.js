...
try { importScripts('/assets/js/a33-release.js?v=4.20.93&r=52'); } catch (e) {}

const SW_VERSION = (self.A33_RELEASE && self.A33_RELEASE.suiteVersion) ? String(self.A33_RELEASE.suiteVersion) : '4.20.93';
...
const PRECACHE_URLS = [
  './',
  './index.html?v=4.20.93&r=12',
  './manifest.webmanifest?v=4.20.93&r=10',
  './logo-icon-192.png',
  './logo-icon-512.png',
  '/assets/js/a33-release.js?v=4.20.93&r=52',
  '/assets/js/a33-storage.js?v=4.20.93&r=20',
  '/assets/js/a33-production.js?v=4.20.93&r=4',
  '/assets/js/a33-currency.js?v=4.20.93&r=14',
  '/assets/js/a33-presentations.js?v=4.20.93&r=15',
  '/assets/js/a33-input-ux.js?v=4.20.93&r=7',
  '/assets/js/a33-theme.js?v=4.20.93&r=7',
  '/assets/css/a33-header.css?v=4.20.93&r=7',
  '/assets/css/a33-theme.css?v=4.20.93&r=7'
];
  ...
  event.respondWith((async () => {
    ...
    try {
      ...
      return (await cache.match(event.request))
        || (isNavigation ? (await cache.match('./index.html?v=4.20.93&r=12')) || (await cache.match('./')) : null)
